...
//    writeToFile("./mocks/10cols.csv", generateData(('A'..'G').toList(), 10, 30))

//    writeToFile("./mocks/100cols.csv", generateData(('A'..'Z').toList(), 100, 50))
    writeToFile("./mocks/1000cols.csv", generateData(('A'..'Z').toList(), 1000, 10))
//    writeToFile("./mocks/100000cols.csv", generateData(('A'..'Z').toList(), 10000, 50))
//    writeToFile("./mocks/1000000cols.csv", generateData(('A'..'Z').toList(), 100000, 50))
